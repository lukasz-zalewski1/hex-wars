...
class Graphics:
    def __init__(self, map_, gameplay, window_size):
        ...
        # This is needed for mouse cursor to send proper position
    ...
    def __init_right_bar(self):
        '''
        Initializes right side bar and controls on it
        '''
    ...
    def __init_hex_right_bar_representation(self):
        '''
        Initializes chosen hex visual representation
        '''
    ...
    def __init_slider_fight_time(self):
        ...
        self.slider_fight_time = controls.Slider(
            ...
            'fight time (ms)', self.font_sliders, 0, 5000,
    ...
    def __init_slider_die_sides_number(self):
        ...
        self.slider_die_sides_number = controls.Slider(
            ...
            [0, -self.right_bar_units[1]], 'single die sides amount',
    ...
    def __init_slider_max_dice_on_single_hex(self):
        ...
        self.slider_max_dice_on_single_hex = controls.Slider(
            self.slider_max_dice_on_single_hex_rect,
            [0, -self.right_bar_units[1]], 'max dice on a single hex',
            self.font_sliders, 2, 99,
            8, 1, (0, 0, 0), (255, 150, 0))
    ...
    def set_options_for_new_map(self):
        ...
        self.gameplay.max_dice_on_single_hex = self.new_game_options.max_dice_on_single_hex
    ...
    def __draw_visible_hexes(self):
        '''
        Draws all hexes in rendering range
        '''

        # The number of dice on a hex text change dependently on hex's side length
        ...
        # If hex is attacking hex draw it outlined
